export const en = {
  ...
  "settings.pluginsSettingsInfo": "Install and manage Plugins: enable, disable, update, and uninstall.",
  ...
  "settings.pluginsInstalledInfo": "Manage Snow-managed Plugins: enable, disable, update, or uninstall.",
  ...
  "settings.pluginsResizeColumns": "Resize installed Plugins and marketplace columns",
  ...
  "settings.pluginsRemoveConfirm": "Uninstall this Plugin and its Snow-managed components?",
  ...
  "settings.pluginsRuntimeConfirm": "Run external Plugin code in an isolated utility process. Only run code you trust.",
  ...
  "settings.pluginsMarketplacesInfo": "Add a local or remote marketplace, then install Plugins from its catalog.",
  "settings.pluginsMarketplaceAdd": "Add marketplace",
  "settings.pluginsMarketplaceSourceLabel": "Marketplace source",
  "settings.pluginsMarketplaceSourcePlaceholder": "./my-marketplace, owner/repo, or https://example.com/marketplace.json",
  ...
  "settings.pluginsMarketplaceRemoveConfirm": "Remove this marketplace and its Snow cache? Installed Plugins are kept.",
  ...
  "settings.pluginsMarketplaceCatalogEmpty": "This marketplace has no installable Plugins.",
  ...
  "settings.importOpenCodeDescription": "Import MCP, Skills, instructions, commands, and agents from OpenCode.",
  ...
  "settings.importSourceSuccess": "Imported {{mcp}} MCP servers, {{skills}} Skills, and {{prompts}} prompts.",
  ...
  "settings.importLastResult": "Last import: {{mcp}} MCP, {{skills}} Skills, {{prompts}} prompts",
  "settings.importCommit": "Import selected",
  "settings.importCommitSummary": "Imported {{imported}}, unchanged {{unchanged}}, skipped {{skipped}}, unsupported {{unsupported}}.",
  ...
  "settings.importPluginPhase4Detail": "Plugin management is scheduled for Phase 4",
  ...
  "settings.importResourceKeepCopyConfirm": "Keep this local copy and remove its import association?",
  "settings.importResourceUnlinkConfirm": "Remove this source association? Other sources will keep the resource available.",
  "settings.importResourceRemoveConfirm": "Remove this import association and delete the Snow-managed resource?",
  "settings.importResourceKeepCopySuccess": "Kept the local copy and removed its import link.",
  "settings.importResourceRemoveSuccess": "Removed the imported resource association.",
  ...
  "chat.streamMetrics.filesChanged": "{{count}} file(s) changed",
