export const en = {
  ...
  "settings.pluginsSettingsInfo": "Manage imported declarative Plugin components.",
  ...
  "settings.pluginsRemove": "Remove Plugin",
  "settings.pluginsRemoveConfirm": "Remove this Plugin and its Snow-managed components?",
  "settings.pluginsRemoveSuccess": "Plugin removed.",
  "settings.pluginsRemoveError": "Failed to remove Plugin",
